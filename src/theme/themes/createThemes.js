...
const defaultThemes = [
  ...
  },
  {
    ...
    config: {
      ...
      font: 'rgb(255, 255, 255)',
      'c-app-background': 'rgba(0, 0, 0, 0.15)',
      'c-main-background': 'rgba(19, 19, 19, 0.9)',
      'bg-image': '133192865_p0.jpg',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',

      'c-badge-primary': 'var(c-primary)',
      'c-badge-secondary': 'var(c-primary-light-200)',
      'c-badge-tertiary': '#ff69b4',
    },
  },
  {
    id: 'anime_2',
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      'c-app-background': 'rgba(255, 255, 255, 0.15)',
      'c-main-background': 'rgba(255, 255, 255, 0.85)',
      'bg-image': '134124384_p0.png',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',

      'c-badge-primary': 'var(c-primary)',
      'c-badge-secondary': '#9370db',
      'c-badge-tertiary': '#ffd700',
    },
  },
  {
    id: 'anime_3',
    ...
    config: {
      ...
      font: 'rgb(255, 255, 255)',
      'c-app-background': 'rgba(0, 0, 0, 0.2)',
      'c-main-background': 'rgba(10, 20, 40, 0.9)',
      'bg-image': '141419367_p0.jpg',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',

      'c-badge-primary': 'var(c-primary)',
      'c-badge-secondary': '#ff6b6b',
      'c-badge-tertiary': '#4ecdc4',
    },
  },
  {
    id: 'anime_4',
    ...
    config: {
      ...
      font: 'rgb(33, 33, 33)',
      'c-app-background': 'rgba(255, 255, 255, 0.15)',
      'c-main-background': 'rgba(255, 250, 250, 0.9)',
      'bg-image': '144841578_p0.png',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',

      'c-badge-primary': 'var(c-primary)',
      'c-badge-secondary': '#ffb6c1',
      'c-badge-tertiary': '#dda0dd',
    },
  },
  {
    id: 'anime_5',
    ...
    isDark: true,
    config: {
      primary: 'rgb(255, 188, 185)',
      font: 'rgb(255, 255, 255)',
      'c-app-background': 'rgba(0, 0, 0, 0.2)',
      'c-main-background': 'rgba(30, 20, 40, 0.9)',
      'bg-image': '144842566_p0.jpg',
      'bg-image-position': 'center',
      'bg-image-size': 'cover',

      'c-badge-primary': 'var(c-primary)',
      'c-badge-secondary': '#ffc0cb',
      'c-badge-tertiary': '#87ceeb',
    },
  },
]
